С удовольствием! REST API — это не просто способ “делать запросы по HTTP”, а архитектурный стиль, у которого есть **чёткие принципы**. Вот полное объяснение на понятном языке:
