...
- Написание микросервисов для передачи и кэширование данных с MDVR на CMS сервер с помощью Koa, Socket.IO, Kafka.JS, Docker-Compose и Redis
- Передача видеопотоков с устройств на фронт приложений с помощью библиотеки Discord LavaPlayer (flv-player)
...
- Пишу курсы по React Native на Stepik.org
